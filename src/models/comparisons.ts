 ...
 * Verdict AI *does*, name the real strengths of the other side first, and
...
export type Comparison = {
  ...
  pickTheirs: string
  /** When Verdict AI is the better pick. */
  pickOurs: string
}
...
export type ComparisonHub = {
  ...
  /** Where Verdict AI sits, and what the closest contenders own. */
  position: string
