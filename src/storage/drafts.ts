 ...
 * localStorage (`verdict-ai:draft:<councilId>`), council *data* lives in
 ...
 * and the factory reset's `verdict-ai:*` prefix sweep clears it regardless.
 */

const KEY_PREFIX = 'verdict-ai:draft:'
