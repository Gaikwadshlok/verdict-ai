...
export function PrivatePage() {
  ...
  return (
    <ProsePage
      ...
      documentTitle="No account, no server — Verdict AI"
      lede={
        <>
          Verdict AI asks several AI models one question and shows you where
    ...
    >
      ...
      >
        ...
        <ParagraphMedium marginTop="0" marginBottom="0">
          Verdict AI is bring-your-own-key: you paste keys for the providers
        ...
        <ParagraphMedium marginTop="0" marginBottom="0">
          ...
          site claiming to be Verdict AI, check that the address bar reads{' '}
          <strong>verdict.ai</strong> — a copied site can imitate everything
      ...
      >
        ...
        <ParagraphMedium marginTop="0" marginBottom="0">
          ...
          is not evidence that they are right. Verdict AI shows you the
