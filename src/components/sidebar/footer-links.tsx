...
export function SidebarFooterLinks({ onSelect }: { onSelect: () => void }) {
  ...
  return (
    ...
    >
      {/* One left-aligned link row — "About" — with the theme
          toggle alone on the right. About leads (the app's own story); The "who's behind this?" attribution moved to the linked ©
