    ...
    >
      ...
      >
        {/* Hero — a two-line lockup: the brand line
            (mark + "Verdict AI") stays short and confident, and the tagline
        ...
        >
          ...
          >
            <span
              className={css({
                ...
                // (6px) — keeps the mark close to the "Verdict AI" wordmark.
                marginRight: '6px',
              })}
            >
              <BrandMark size={30} />
          ...
          >
            ...
            No account, no server, your own API keys — Verdict AI runs in
